...
const dh_contents = [
    ...
    ["김동혁", "다함께 알고리즘 스터디<br/>미적분학 복습", "미정", UNDEFINED_SIGN, ""], // 8월 둘째주
...
const dy_contents = [
    ...
    ["김동연", "다함께 알고리즘 스터디<br/>자바스크립트 강의 3~4개 수강", "미정", UNDEFINED_SIGN, ""],
    ["김동연", "", "", FAIL_SIGN, ""]];
...
const hj_contents = [
    ...
    ["최현준", "다함께 알고리즘 스터디<br/>노마드 코더 SCSS 완강<br/>자바스크립트 강의 훑기<br/>미적분학 복습", "[TEXTI] JS로 JJALB(짧) 제작", UNDEFINED_SIGN, ""],
    ["최현준", "", "", FAIL_SIGN, ""]];
