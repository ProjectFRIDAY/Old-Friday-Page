...
const dh_contents = [
    ...
    ["김동혁", "다함께 알고리즘 스터디<br/>미적분학 복습", "워드프로세서 실기 합격", UNDEFINED_SIGN, ""]]; // 8월 셋째주
...
const dy_contents = [
    ...
    ["김동연", "다함께 알고리즘 스터디<br/>CSS 강의 수강", "미정", UNDEFINED_SIGN, ""]];
...
const hj_contents = [
    ...
    ["최현준", "다함께 알고리즘 스터디<br/>노마드 코더 JS 수강(그림판/줌)<br/>노마드 코더 SCSS 클론 코딩 실습<br/>미적분학 복습<br/>정보처리기능사 준비<br/>C Programming 6~10", "<del>[TEXTI] JJALB(짧) 보완</del><br/><del>[TEXTI] JJALB(짧) 홍보하기</del>", UNDEFINED_SIGN, ""]];
